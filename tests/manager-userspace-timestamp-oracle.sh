...
#
# Read-only v261 Manager oracle for the dual userspace startup timestamps.
...
for property in UserspaceTimestamp UserspaceTimestampMonotonic; do
...
realtime_first=$(get_property UserspaceTimestamp)
realtime_second=$(get_property UserspaceTimestamp)
monotonic_first=$(get_property UserspaceTimestampMonotonic)
monotonic_second=$(get_property UserspaceTimestampMonotonic)
[ "$realtime_first" = "$realtime_second" ]
[ "$monotonic_first" = "$monotonic_second" ]
[ "$realtime_first" -gt 0 ]
[ "$monotonic_first" -gt 0 ]

printf '%s\n' 'manager userspace timestamp oracle: PASS'
